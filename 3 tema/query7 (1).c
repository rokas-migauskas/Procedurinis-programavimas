...
int gradesBetween(Student s, int upperLimit, int lowerLimit);
...
int main(int argc, char *argv[]) {
	...
	if (db){							
		...
		for (int i = 0; i < size; ++i){ // process all the student records in database
			...
			if(gradesBetween(s,9,6)==1){ // *** first filter, conditions on the student
